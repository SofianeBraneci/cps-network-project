...
public class AccessPointComponent extends AbstractComponent {
	...
	protected AccessPointComponent() throws Exception {
		...
		this.accessPointCommunicationInbountPort = new AccessPointCommunicationInbountPort(ACCESS_POINT_COMMUNICATION_INBOUND_PORT_URI,	this);
		this.accessPointCommunicationOutBoundPort = new AccessPointCommunicationOutBoundPort(ACCESS_POINT_COMMUNICATION_OUTBOUND_PORT_URI, this);
		this.accessPointRoutingInboundPort = new AccessPointRoutingInboundPort(ACCESS_POINT_ROUTING_INBOUND_PORT_URI, this);
		this.registrationOutboundPort = new AccessPointRegistrationOutboundPort(ACCESS_POINT_REGISTRATION_OUTBOUND_PORT_URI, this);
	...
	public synchronized void execute() throws Exception {
		...
		Set<ConnectionInfo> connectionInfos = registrationOutboundPort.registerAccessPoint(address, ACCESS_POINT_COMMUNICATION_INBOUND_PORT_URI, initialPosition, initialRange, ACCESS_POINT_ROUTING_INBOUND_PORT_URI);
