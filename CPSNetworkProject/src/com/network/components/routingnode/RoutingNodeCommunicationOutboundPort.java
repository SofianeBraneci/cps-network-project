...
public class RoutingNodeCommunicationOutboundPort extends AbstractOutboundPort implements CommunicationCI{
	...
	public RoutingNodeCommunicationOutboundPort(String uri, ComponentI owner) throws Exception {
